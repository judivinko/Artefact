...
const RECIPES_T3 = {
  ...
  T3_CHEST_OF_SECRETS:["T2_WOODEN_CHEST","T2_WOODEN_CHEST","T2_WOODEN_CHEST","T2_LEATHER_BAG","T2_OBSIDIAN_KNIFE"],
  T3_PILLAR_OF_STRENGTH:["T2_STONE_PILLAR","T2_STONE_PILLAR","T2_STONE_PILLAR","T2_IRON_ARMOR","T2_BRONZE_DOOR"],
  T3_TRAVELERS_BAG:["T2_LEATHER_BAG","T2_LEATHER_BAG","T2_LEATHER_BAG","T2_CLOTH_TENT","T2_WOODEN_CHEST","T2_IRON_ARMOR"],
  T3_NOMAD_TENT:["T2_CLOTH_TENT","T2_CLOTH_TENT","T2_CLOTH_TENT","T2_LEATHER_BAG","T2_WOODEN_CHEST","T2_STONE_PILLAR"],
  T3_ORB_OF_VISION:["T2_CRYSTAL_ORB","T2_CRYSTAL_ORB","T2_CRYSTAL_ORB","T2_SILVER_GOBLET","T2_GOLDEN_RING","T2_STONE_PILLAR"],
  T3_KNIFE_OF_SHADOW:["T2_OBSIDIAN_KNIFE","T2_OBSIDIAN_KNIFE","T2_OBSIDIAN_KNIFE","T2_OBSIDIAN_KNIFE","T2_LEATHER_BAG","T2_IRON_ARMOR","T2_WOODEN_CHEST"],
...
const RECIPES_T4 = {
  ...
  T4_MIGHT_GATE:["T3_GATE_OF_MIGHT","T3_GATE_OF_MIGHT","T3_GATE_OF_MIGHT","T3_PILLAR_OF_STRENGTH","T3_ARMOR_OF_GUARD","T3_CHEST_OF_SECRETS"],
  T4_NOMAD_DWELLING:["T3_NOMAD_TENT","T3_NOMAD_TENT","T3_NOMAD_TENT","T3_TRAVELERS_BAG","T3_CHEST_OF_SECRETS","T3_ARMOR_OF_GUARD"],
  T4_SECRET_CHEST:["T3_CHEST_OF_SECRETS","T3_CHEST_OF_SECRETS","T3_CHEST_OF_SECRETS","T3_TRAVELERS_BAG","T3_NOMAD_TENT","T3_KNIFE_OF_SHADOW"],
  T4_SHADOW_BLADE:["T3_KNIFE_OF_SHADOW","T3_KNIFE_OF_SHADOW","T3_KNIFE_OF_SHADOW","T3_KNIFE_OF_SHADOW","T3_CHEST_OF_SECRETS","T3_ARMOR_OF_GUARD","T3_GATE_OF_MIGHT"],
  ...
  T4_TRAVELER_SATCHEL:["T3_TRAVELERS_BAG","T3_TRAVELERS_BAG","T3_TRAVELERS_BAG","T3_TRAVELERS_BAG","T3_NOMAD_TENT","T3_CHEST_OF_SECRETS","T3_RING_OF_GLARE"],
  T4_VISION_CORE:["T3_ORB_OF_VISION","T3_ORB_OF_VISION","T3_ORB_OF_VISION","T3_ORB_OF_VISION","T3_GOBLET_OF_WISDOM","T3_RING_OF_GLARE","T3_CHEST_OF_SECRETS","T3_GATE_OF_MIGHT"],
...
const RECIPES_T5 = {
  ...
  T5_VAULT:["T4_SECRET_CHEST","T4_SECRET_CHEST","T4_SECRET_CHEST","T4_SECRET_CHEST","T4_MIGHT_GATE","T4_STRENGTH_PILLAR","T4_ENGINE_CORE"],
  T5_COLOSSAL_PILLAR:["T4_STRENGTH_PILLAR","T4_STRENGTH_PILLAR","T4_STRENGTH_PILLAR","T4_STRENGTH_PILLAR","T4_ENGINE_CORE","T4_MIGHT_GATE","T4_NOMAD_DWELLING","T4_VISION_CORE"],
  T5_WAYFARER_BAG:["T4_TRAVELER_SATCHEL","T4_TRAVELER_SATCHEL","T4_TRAVELER_SATCHEL","T4_TRAVELER_SATCHEL","T4_NOMAD_DWELLING","T4_VISION_CORE","T4_SECRET_CHEST","T4_WISDOM_GOBLET"],
  T5_EYE_OF_TRUTH:["T4_VISION_CORE","T4_VISION_CORE","T4_VISION_CORE","T4_VISION_CORE","T4_CRYSTAL_LENS","T4_WISDOM_GOBLET","T4_STRENGTH_PILLAR","T4_SECRET_CHEST"],
  T5_NIGHTFALL_EDGE:["T4_SHADOW_BLADE","T4_SHADOW_BLADE","T4_SHADOW_BLADE","T4_SHADOW_BLADE","T4_VISION_CORE","T4_STRENGTH_PILLAR","T4_SECRET_CHEST","T4_MIGHT_GATE","T4_TRAVELER_SATCHEL"],
